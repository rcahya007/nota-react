...
const ModalFormTambahNota = ({closeModal,setDataBarang}) => {
    ...
    const getId = async (id) => {
        const getDataById = await axios.post(`https://crud-react-firsttime.herokuapp.com/barang/selectId/`+id);
    ...
    const getBarang = async (e) => {
        ...
        if(nama_barang === ''){
            ...
            const fetch = await axios.post('https://crud-react-firsttime.herokuapp.com/getBarangFormTambah',{nama_barang: nama_barang});
